    ...
    <>
      <section className="flex justify-center items-center py-[80px] lg:py-[80px] px-4 lg:px-[80px] lg:gap-[80px]">
        ...
        <div data-aos="zoom-in">
          <div className="w-full mx-auto lg:w-[500px] text-center lg:border lg:shadow-md bg-white rounded-[4px] p-0 lg:p-[40px]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                ...
                <p className="text-xs text-center mx-auto w-[290px] lg:w-[400px] mt-3">
