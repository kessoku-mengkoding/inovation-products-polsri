          ...
          <div className="flex gap-[40px] mt-[80px] items-center">
            <div className="flex flex-col gap-[40px]">
              <div className="flex gap-[10px] justify-end text-right">
                <div>
                  ...
                  <p>Lacak detak jantung, tingkat aktivitas, dan tidur Anda.</p>
                </div>
            ...
            <div className="flex flex-col gap-[40px]">
              ...
              <div className="flex  gap-[10px] items-start text-left">
                ...
                <div>
                  <h3 className="font-semibold text-2xl mb-1">Desain Elegan</h3>
                  <p>
        ...
        <section>
          <div className="flex flex-col lg:flex-row lg:relative">
            <img
              ...
              alt="about"
            />
            <div className="pt-4 lg:p-[60px] bg-white lg:absolute lg:w-[680px] h-max lg:bottom-0 lg:right-0 ">
              <p className="text-brand text-sm font-medium mb-2">
              ...
              <p className="text-base mb-8 max-w-[580px]">
                ...
                berguna tetapi juga memadukan keindahan desain. Saya berkomitmen
                untuk memberikan nilai tambah kepada pengguna dengan setiap
